...
const { EmailInUseError } = require("../../../../server/errors");
...
export default async function handler(req, res, next) {
    if (req.method === "POST") {
        ...
        let result = await getUsers(req.query.type, req.query.status, req.query.role,
            req.query.date, req.query.availability, req.query.email, req.query.lastPaginationId, req.query.pageSize, next);
