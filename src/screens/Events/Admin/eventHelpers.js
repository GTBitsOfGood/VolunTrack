...
,
  ...
  pocEmail: string().trim().email("Invalid email").required(" POC email is required"),
  ...
  orgZip: string().trim().matches(/^\d+$/, " ZIP should have digits only").required(" Org ZIP is required"),
  isPrivate: string().trim().required(),
});
