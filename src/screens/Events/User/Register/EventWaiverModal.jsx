    ...
    return (
        <Modal isOpen={open} toggle={toggle} size="lg" centered="true">
            ...
            <Styled.Row/>
            {
                ...
                <React.Fragment>
                    <Styled.Row>
                        <Styled.HighlightText>Before you can finish registration. Please review the following waivers for yourself and your accompanying minors.</Styled.HighlightText>
                    </Styled.Row>
                    <Styled.Row>

                    {
                        ...
                        <React.Fragment>
                            <Link href="/register">
                                <Styled.Tab>
                                    <Styled.PrimaryText onClick={ onGuardianClicked }>Guardian</Styled.PrimaryText>
                                    <IconSpecial width="8" height="8" viewBox="0 0 8 8" name="highlightTab"/>
                                </Styled.Tab>
                            </Link>
                            <Link href="/register">
                                <Styled.SecondaryTab>
                                    <Styled.PrimaryText onClick={ onMinorsClicked }>Minors</Styled.PrimaryText>
                                    <IconSpecial width="8" height="8" viewBox="0 0 8 8" name="highlightTab"/>
                                </Styled.SecondaryTab>
                            </Link>
                        </React.Fragment>
            ...
            }
            {
                !hasMinor &&             
                <Styled.Row>
                    <Styled.HighlightText>Before you can finish registration. Please review the following waiver.</Styled.HighlightText>
                </Styled.Row>
            }
