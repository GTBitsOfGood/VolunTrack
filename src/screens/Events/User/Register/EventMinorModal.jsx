...
const EventMinorModal = ({ open, toggle, event }) => {
    ...
    return (
        <Formik
            ...
            <React.Fragment>
                <Modal isOpen={open} toggle={toggle} background="static" size="lg" centered="true">
                    <Styled.ModalHeader>
                    ...
                    <SForm.FormGroup>
                        ...
                        <Styled.Row>
                            <Styled.Col>
                                ...
                                {({ field }) => <SForm.Input {...field} type="text" onBlur={ handleBlur }/>}
                                </Field>
                            </Styled.Col>
                            <Styled.Col>
                ...
                <React.Fragment>
                    {showSuccess && <Styled.ConfirmationModal isOpen={open} toggle={toggle} size="lg">
                        <Styled.Container>
                            <Row>
                                <Styled.Col xs="11">
