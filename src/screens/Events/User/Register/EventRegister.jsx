    ...
    return (
        <Styled.Container fluid="md">
                ...
                <Styled.Row>
                    ...
                    <Col xs="12" lg="10">
                        <Styled.EventContainer>
                            ...
                            <Styled.Row/>
                            <Styled.Row>
                                <Styled.MainText>We’ve sent a confirmation email. See you soon!</Styled.MainText>
                            </Styled.Row>
                            <Styled.Row>
                            ...
                            <Styled.Row style={{flex: 1}}>
                                ...
                                <Styled.SectionText/>
                                <Styled.LinkedTextRight>Cancel Registration</Styled.LinkedTextRight>
                            </Styled.Row>
                        </Styled.EventContainer>
            ...
            <Styled.Row>
                ...
                <Link href="/register">
                    <Styled.LinkedText onClick={ onAddMinorClicked }>Add Minor (under 13 years old)</Styled.LinkedText>
                </Link>
            </Styled.Row>
            ...
            </Styled.Row>  
            {
                !isRegistered && 
                <Styled.ModalFooter>
                    <Styled.Button onClick={onCompleteRegistrationClicked}>Complete Registration</Styled.Button>
                </Styled.ModalFooter> 
            }
            <EventMinorModal
                open={showMinorModal}
