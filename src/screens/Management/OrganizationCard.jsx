    ...
    <div className="flex justify-center">
      <Card className="bg-gray-300">
        <div className="flex justify-center space-x-3">
          ...
          <div>Requested Date: {new Date(org.createdAt).toDateString()}</div>
          <div className={org.active ? "text-green-400" : "text-red-400"}>
            Recent Update: {org.active ? "Activated " : "Deactivated "}on{" "}
            {new Date(org.updatedAt).toDateString()}
          </div>
        </div>
        <div className="flex justify-center space-x-8">
          <div className="flex flex-col">
            ...
            <div>{org.defaultContactName}</div>
            <div className="font-semibold">Primary Admin Account</div>
            <div>{org.defaultContactEmail}</div>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <div>{org.defaultContactPhone}</div>
          </div>
        </div>
      </Card>
    </div>
